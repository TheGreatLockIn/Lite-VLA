...
Provide the mental model and logical strategy. Explain how a senior developer starts thinking about the solution before writing any syntax. Keep analogies brief, concrete, and secondary to the code itself.

### Step 4: Imports Explained
Include a table detailing every library and package imported in the file:
* **Import Statement:** The exact import text.
* **What it is:** A simple description of the library.
* **Why we use it here:** Its specific role in this file.
* **Concept Link:** Hyperlink to the relevant section under `docs/mentorship/concepts/`.

### Step 5: Code Walkthrough
Provide a complete, top-to-bottom breakdown of **every global constant, class, and function** in the file. Do not skip any line of logic. Use this template for each element:
